...
function CRGR_Home({ navigation, route }) {
  ...
  const goto_CRGR = () => {
    navigation.navigate("CRGRCourse", { user: route.params.id,roleof:role });
  };
  ...
  return (
    <SafeAreaView style={{ backgroundColor: "#FFFFF" }}>
      ...
      <View style={styles.allocation}>
        <Image source={require("../assets/claim.png")} style={styles.lowerimages}></Image>
        <TouchableOpacity onPress={goto_CRGR}>
          <Text style={styles.allocationtext}>Lecture</Text>
        </TouchableOpacity>
      </View>
