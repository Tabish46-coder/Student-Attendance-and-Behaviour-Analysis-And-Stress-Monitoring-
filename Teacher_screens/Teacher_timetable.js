...
const TeacherTimetableComponent = ({ navigation, route }) => {
...
console.log(employeno)
            ...
            const response = await fetch(`${callurl}teachertimetable?teacher_id=${employeno}&semester_no=${semesterNo}&slot_day=${slot_day}`, {
                method: 'GET',
                headers: {
